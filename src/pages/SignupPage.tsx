      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary dark:bg-black">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-md">
            Join thousands of learners who have mastered Hindi typing with our
            comprehensive platform. Get started with a 3-day free trial.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>3 days free trial - No credit card required</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <Check className="h-5 w-5" />
              </div>
              <span>Access to all keyboard layouts</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <Check className="h-5 w-5" />
              </div>
              <span>CPCT-style practice tests</span>
            </div>
          </div>
        </div>
      </div>
